<div data-modal="permisions" class="modal-cont flex w-screen h-full justify-center items-center absolute top-0 z-50">
  <div class="modal bg-white overflow-hidden">
