...
<div data-users="list" class="w-full h-full absolute top-0 z-0 bg-gray-300 ">
  <div class="header flex items-center w-full h-12 bg-white shadow-lg pl-16  text-gray-500">
    <button  type="button" name="create" class="flex items-center p-1 mr-4 text-green-600">
      <i class="fas fa-user-plus mr-2"></i>
      Agregar
    </button>
    <button  type="button" name="delete" class="flex items-center p-1 mr-4 text-red-600" >
