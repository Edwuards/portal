...
foreach ($buttons['elements'] as $button) {
  ...
  <div class=" my-2 flex items-center justify-end absolute right-0 bottom-0 permision hide">
    ...
    <button type="button" name="'.$button['name'].'" class="form '.$buttons['css'].' '.$colors[$i].'">
...
<div id="permisions" class="permisions-cont flex flex-col justify-end items-end right-0 sm:rounded-full bottom-0 z-20 pr-10 pb-10">
    <?php echo $html ?>
